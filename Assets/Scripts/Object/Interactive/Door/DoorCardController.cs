...
public class DoorCardController : MonoBehaviour
{
    ...
    private GameObject _hightLightRed;
    ...
    private void Awake()
    {
        ...
        _hightLightRed = this.transform.GetChild(1).gameObject;
    }
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        if (other.gameObject.name == "Player")
        {
            ...
            if (other.GetComponent<PlayerController>().HasDoorCard)
                _hasDoorCard = true;
        }
    }
    ...
    {
        _hightLightRed.SetActive(true);
        yield return new WaitForSeconds(0.1f);
        _hightLightRed.SetActive(false);
        yield return new WaitForSeconds(0.1f);
        _hightLightRed.SetActive(true);
        yield return new WaitForSeconds(0.1f);
        _hightLightRed.SetActive(false);
